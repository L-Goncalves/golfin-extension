...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "dark:focus:border-neon-cyan-500/40 dark:focus:shadow-neon-cyan/10",
      "dark:focus:ring-neon-cyan-500/30",
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-popover text-popover-foreground shadow-lg backdrop-blur-xl",
        ...
        "dark:backdrop-blur-xl dark:shadow-dark-xl",
        position === "popper" &&
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      // Dark mode styles
      "dark:focus:bg-dark-700/60 dark:focus:text-white",
      "dark:hover:bg-dark-700/60 dark:hover:text-white",
      className
    )}
    {...props}
  >
    <span className="absolute left-2 flex h-4 w-4 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-4 w-4 text-primary dark:text-neon-cyan-400" />
      </SelectPrimitive.ItemIndicator>
    </span>
